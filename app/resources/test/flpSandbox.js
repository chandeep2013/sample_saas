		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TrialBalance",
									"targetURL": "#TRtrialbalance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TRtrialbalance-display": {
								"semanticObject": "TRtrialbalance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=TR.trialbalance",
									"url": sap.ui.require.toUrl("TR/trialbalance")
								}
							}
						}
					}
